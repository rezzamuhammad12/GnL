                            ...
                            <?php foreach ($video as $v) : ?>
                                ...
                                <div class="card mb-3" style="max-width: 540px;">
                                    <div class="row no-gutters">
                                        <div class="col-md-5">
                                            <?php if ($user['role_id'] == 3 && $v['kelas'] == 'premium' || $v['kelas'] == 'free') : ?>
                                                <iframe width="560" height="315" src="<?= $v['link']; ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                            <?php else : ?>
                                        ...
                                        <div class="col-md-7">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text"><small class="text-muted">15 menit</small></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
